...
// removing the about-to-be-deleted strings (garbage collection)
void tableRemoveWhite(Table* table);

// global variables live in a hash table owned by the VM,
// so this declares another helper function for marking all the objects in a table
