...
class Parser {
    ...
    private int loopDepth = 0; // track nested loops for 'break' statements
    ...
    private Stmt forStatement() {
        ...
        // we wrap the loop body and track loop depth for 'break'
        try {
            loopDepth++;
            Stmt body = statement();
            ...
            // if the condition is omitted, treat it as true
